...
在创建文件数据集之前，请确保已完成[目标文件上传](/maxirai/user-guide/7-data-source-mgmt.md#上传文件)。
...
在创建文件数据集之前，请确保已完成目标[数据库数据源的创建](/maxirai/user-guide/7-data-source-mgmt.md#创建数据库数据源)。
...
> 关于如何修改数据库数据集中数据库的元数据信息，请参考[修改数据库的元数据](/maxirai/user-guide/7-data-source-mgmt.md#修改数据库的元数据)章节。
